...
template void Movement::checkForShapeMovement(std::array<std::unique_ptr<Trapezoid>, 3>&);
...
template void Movement::checkForShapeArrayMovement(VectorOfArrayOfTrapezoidPtrs&);
