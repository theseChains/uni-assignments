...
namespace color
{
	inline const sf::Color background{ 20, 20, 36 };
	// king krule - baby blue
	inline const sf::Color vertex{ 137, 207, 240 };
	inline const sf::Color text{ 190, 190, 255 };
	inline const sf::Color line{ 65, 158, 230 };
